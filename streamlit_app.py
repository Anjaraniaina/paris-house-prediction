...
squareMeters = st.slider("What is the total square meters of the house?", min_value=0, max_value=100000)
...
made = st.slider("What year was the house made?", min_value=1970, max_value=2024)
